...
date: "2026"
publisher: "Guinea / International Edition"
rights: "© 2026 Abdourahamane Diallo. Reproduction, translation, and citation permitted for non-commercial purposes with attribution."
language: en-US
lang: en-US
subject: "Political economy, development, statecraft, Guinea"
keywords: [Guinea, Simandou, statecraft, development, political economy, mining, governance, West Africa]
toc-title: "Contents"
...

<!--
============================================================================
 DOCTRINE-ONLY EDITION
 This is the principles-only edition. The prescriptive, plan-like passages
 of the full manuscript (budget allocations, the five-element constitution
 checklist, the named institutions, the city-by-city geography, and the four
 named corridors) have been removed so the book states what the state must
 BECOME, not what a government should build. Nothing was added except a few
 connective phrases to close the seams left by removal; every such seam is
 listed in /editorial/doctrine-edition-changes.md. The full edition remains
 at manuscript/Beyond-Simandou.md.

 PUBLICATION-READY MASTER MANUSCRIPT
 This single Markdown file is the source of truth for all output formats
 (EPUB, KDP paperback PDF, DOCX, audiobook script). See /production for
 platform-specific build and formatting guidance, and /editorial for the
 editorial report and the list of figures flagged for sourcing.

 Conventions used in this file:
   #        = front/back matter page OR a Part (chapter) opener
   ##       = section heading within a Part
   > **...**= set-off callout box (National Rule / Core Doctrine / Governing
              Question) or a display pull-quote
   ::: ...  = pandoc fenced div used for special page styling
 Front- and back-matter headings are marked {.unnumbered} so they are not
 counted as Parts.
============================================================================
-->

# Half Title {.unnumbered .unlisted}
...
<!-- The title page is generated automatically from the YAML metadata block
     at the top of this file (title, subtitle, author, date), which also
     supplies the EPUB/file metadata required by retailers. Edit it there. -->
...
Copyright © 2026 Abdourahamane Diallo. All rights reserved.

First published 2026 · Guinea / International Edition.

Language of original: English. French translation in preparation.

**Rights and citation.** This doctrine may be reproduced, translated, cited, and distributed freely for non-commercial purposes, provided the source is acknowledged. Those who adopt its framework as a governing philosophy are encouraged to do so publicly, so that citizens can hold them accountable to its principles.
...
For correspondence, partnership inquiries, translation rights, or institutional engagement regarding this doctrine, contact the author directly.

<!-- KDP / print metadata to be inserted at final typesetting:
     ISBN (paperback): __________
     ISBN (ebook):     __________
     Cover design:     __________
     Interior design / typesetting: __________
     Printed by Amazon KDP -->

ISBN (paperback): \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

ISBN (ebook): \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
<!-- EDITORIAL NOTE (not for print): No dedication appeared in the source
     manuscript. The text above is a suggested dedication drawn solely from
     the imagery of the Preface ("among the most capable... it gave him only
     one — out"). The author should approve, revise, or replace it. -->
...
**Part XIII** — From Projects to Systems
...
<!-- Print production: insert page numbers against each entry at final
     typesetting. In the ebook this page is generated as a linked navigation
     list and page numbers are omitted. -->

\newpage

# The Architecture of This Doctrine {.unnumbered}
...
**III. The Institutional Architecture.** The three National Rules, the Capability-Dependency framework, the Foreign Capital Doctrine, and the separation of power from the security network define how power must be constrained and protected against capture.

**IV. The Geographic Principle.** No country develops when one city monopolizes opportunity while every region waits for redistribution. Development must be distributed — a networked republic in which every region has a productive role tied to its real advantages, not merely a political constituency connected to the capital by patronage.

**V. The Test.** Are more Guineans creating value than controlling access to value? When the answer is yes, the doctrine is working. When the answer is no, something has been captured. The mines are not the test. The state is the test.

> **On the governing questions.** This doctrine settles what analysis can settle. It also names, inside the sections where they belong, four governing questions that only governing can resolve. They are not failures of analysis. They are the honest boundary between doctrine and statecraft.

\newpage

# The Doctrine in One Page {.unnumbered}
...
**The geography.** Development must be distributed, not concentrated — a networked republic in which every region has a productive role, not a patronage relationship with the capital.
...
# Preface: Why This Document Exists {.unnumbered}
...
This doctrine is built around one claim, one principle, three National Rules, a Resource Constitution, four governing questions, and one test.
...
This is not a moral failure. It is a rational response to incentives. When the highest returns in an economy flow not from producing value but from controlling access to value — access to licenses, contracts, exemptions, land, customs channels, procurement decisions, import monopolies, and resource rents — rational actors pursue access rather than production.
...
The doctrine must name one mechanism of productive suppression that is larger in scale than elite capture, more pervasive than customs corruption, and more structurally embedded than any individual rent-seeking network: the systematic exclusion of women from economic participation.
...
The principle is not which project comes first but that capability must precede capital: money spent before the enabling layer exists produces debt, not assets. A country that imports food while leaving most of its agricultural potential idle has not failed at farming. It has failed at governance.
...
What such a constitution exists to protect is not a set of procedures but a set of principles. Opacity is not negotiating discretion. It is the infrastructure of institutional theft. Customs is Guinea's hidden mine — a system that leaks enormous revenue into private networks through misinvoicing, exemption abuse, and valuation manipulation. And no productive state can function when armed authority controls ports, customs, procurement, mining licenses, or commercial enforcement. The military's constitutional role is to protect the republic. The moment it becomes a commercial actor, it becomes a structural obstacle to every reform that follows.
...
Every major project must leave behind more Guinean capability than existed before the project began. Not more concrete. Not more equipment. More capability. Measurably more — in the form of trained engineers, qualified managers, certified technicians, experienced regulators, and capable procurement officers who remain in Guinea after the project concludes.
...
Land governance must arrive before large-scale investment. Compensation decisions made by entities that benefit from displacement are not compensation. They are dispossession with paperwork. And legitimate adjudication cannot rest on any single authority, because the state alone lacks legitimacy, customary systems alone lack enforceability, and investors alone generate no trust.

No major infrastructure corridor, mining concession, or agricultural investment should proceed in the Forest Region until that governance exists. This is not delay. This is the prevention of conflict that stops development for decades.
...
Guinea's bauxite sector involves substantial Chinese financing. The Simandou development involves major Chinese-linked consortia. Existing contractual commitments create constraints that must be acknowledged honestly. The challenge is not resisting Chinese capital — or any external capital. The challenge is ensuring that foreign capital builds Guinean capability rather than substituting for it.
...
- Armed authority must not be the arbiter of political competition. Security power that decides political outcomes is the mechanism by which the real map detaches from the formal one.
...
> The mines are not the test. The state is the test. And the state is real only when the power that governs on paper is the same power that governs in fact.
...
- Major infrastructure built for a single resource project must never be left as that project's private property. Infrastructure engineered to serve only one company, closed to a region's agriculture and general freight, throws away most of the value the nation paid for in disruption, land, and risk.
...
For this reason, Guinea should not think primarily in projects. It should think in systems. A corridor is not a road. A corridor is an economy.

The most important shift in Guinea's development thinking is from sector logic to corridor logic. Sector logic asks what a single ministry should do. Corridor logic asks what economic system should emerge between one region and another. Corridors force integrated thinking because a corridor only functions when all its components function simultaneously — power, transport, skills, agriculture, logistics, customs, and institutions working as one system.

The aim is to transform Guinea from a hub-and-spoke economy centered on Conakry into a networked economy with many outward connections, many productive specializations, many sources of national income, and no single point of failure.

Does it make productive activity more rewarding than political access? If yes, it advances the doctrine. If no, it is merely another road.

\newpage

# The Final Doctrine {.unnumbered}
...
When engineers are valued above brokers — when exporters outperform intermediaries — when manufacturers outperform monopolists — when a young Guinean with technical skill earns more and rises faster than one with political connections — when a truck driver earns more than the official who used to control the checkpoint — when a trader chooses Guinea because it is genuinely faster and cheaper, not because someone was paid — when a gold miner formalizes because the formal system genuinely serves him better than the informal one — when a woman owns the land she farms and can borrow against it to build a business — when a farmer can move her harvest to market rather than watch it rot on an unpaved road — when a general understands that the republic he protects is stronger precisely because he does not manage its ports — when a minister knows that the contract she signs will be read tomorrow by every citizen with a phone — when the 300,000 young Guineans who enter the labor market this year find that building something is more rewarding than knowing someone — that is the moment Guinea begins to transform.

Not before.

Simandou will provide revenue. Revenue is not transformation.

Infrastructure will provide connectivity. Connectivity is not transformation.
...
*Contact and correspondence.* For correspondence, partnership inquiries, translation rights, or institutional engagement regarding this doctrine, contact the author directly.

<!-- AUTHOR PLACEHOLDER — complete before publication:
     • Contact email or website: __________
     • Social / professional links: __________
     • Author photograph (for print back cover and ebook author page): __________
     • Optional extended biography (education, prior work, affiliations): __________ -->

\newpage

# A Note on Figures and Sources {.unnumbered}
...
<!-- EDITORIAL NOTE (not for print): The complete, location-by-location list
     of figures and claims flagged for citation is in
     /editorial/citations-and-verification.md. The author should resolve
     those before commercial publication; several are central to the book's
     argument. -->
